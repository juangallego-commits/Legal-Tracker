...
const ED_TEAM = [
  ...
  { id: 'ab', name: 'Ana Bravo', role: 'HQ Legal', avatar: 'AB', color: '#6B4D7A', load: 3, capacity: 6, overdue: 1, blocked: 0 },
];
...
const ED_NAV_BY_ROLE = {
  specialist: [
    { section: 'Mi día', items: [{id:'home',label:'Inicio',badge:null},{id:'mistareas',label:'Mis tareas',badge:7},{id:'agrupadas',label:'Por prioridad',badge:null}]},
    { section: 'Donde participo', items: [{id:'proyectos',label:'Mis proyectos',badge:3},{id:'historial',label:'Cerradas',badge:null}]},
    { section: 'Entradas', items: [{id:'bandeja',label:'Bandeja',badge:5},{id:'actividad',label:'Actividad',badge:null}]},
  ],
  manager: [
    ...
    { section: 'Entradas', items: [{id:'bandeja',label:'Bandeja',badge:7},{id:'actividad',label:'Actividad',badge:null}]},
  ...
  hq: [
    ...
    { section: 'Entradas', items: [{id:'bandeja',label:'Bandeja',badge:14},{id:'actividad',label:'Actividad',badge:null}]},
    { section: 'Insights', items: [{id:'analytics',label:'Analytics',badge:null},{id:'historial',label:'Historial',badge:null}]},
  ],
};

// ═══ CONFIDENCIALIDAD ═══════════════════════════════════════════
// 3 niveles. Cualquiera del equipo legal puede marcar cualquier nivel.
const ED_CONF_LEVELS = {
  estandar: {
    id: 'estandar',
    label: 'Estándar',
    short: 'Estándar',
    desc: 'Visible para todo el equipo legal del país.',
    dot: '#7CA88B',          // verde calmo
    band: '#EEF3EE',
    bandInk: '#3F5848',
    icon: '○',
  },
  restringido: {
    ...
    label: 'Restringido',
    short: 'Restringido',
    desc: 'Sólo asignados + manager del país.',
    dot: '#C99A2E',          // ámbar
    band: '#FBF4E2',
    bandInk: '#7A5A12',
    icon: '◐',
  ...
  confidencial: {
    ...
    label: 'Confidencial',
    short: 'Confidencial',
    desc: 'Sólo personas nombradas. Watermark en documentos.',
    dot: '#B23A3A',          // rojo apagado
    band: '#F8E9E9',
    bandInk: '#7A2424',
    icon: '●',
  },
...
Object.assign(window, { ED_PEOPLE, ED_TEAM, ED_TASKS_MINE, ED_BUCKETS_MINE, ED_PROJECTS_MINE, ED_TRACKER, ED_NAV_BY_ROLE, ED_CONF_LEVELS });
