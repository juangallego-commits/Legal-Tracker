...
function EdHomeSpecialist({ theme = 'light' }) {
  ...
  return (
    ...
    <div className="ed-root">
      ...
      <main className="ed-main">
        ...
        <div className="ed-eye">Jueves 23 abril · 10:15</div>
        <h1 className="ed-h1">Buenos días, Juan Camilo.<br/>Tienes <em>3 cosas</em> apremiantes hoy.</h1>
        <p className="ed-lede">
          <span className="crit">Una vencida hace 3 días</span> bloqueada por RR.HH.,
          <span className="crit"> una vence hoy</span> esperando firma del Privacy Officer,
          y otra venció ayer pero está en curso. Tu racha on-time es de <b>7 cierres</b> consecutivos —
          <span className="good"> sigue siendo buena.</span>
        </p>

        {/* HERO STATS — qué hago AHORA */}
        <div className="esp-hero">
          <div className="esp-stat">
            <div className="esp-stat-lbl">Vencidas</div>
            <div className="esp-stat-num crit">02</div>
            <div className="esp-stat-ctx"><span className="crit">3 días</span> · 1 día</div>
          </div>
          <div className="esp-stat">
            <div className="esp-stat-lbl">Vencen hoy</div>
            <div className="esp-stat-num warn">01</div>
            <div className="esp-stat-ctx">SLA Alta · firma pendiente</div>
          </div>
          <div className="esp-stat">
          ...
          <div className="esp-stat">
            <div className="esp-stat-lbl">Bloqueadas</div>
            <div className="esp-stat-num warn">01</div>
            <div className="esp-stat-ctx">RR.HH. · 4d sin respuesta</div>
          </div>
        </div>

        {/* WHAT TO DO NOW */}
        <section className="ed-section">
          <div className="ed-h2">— En tu mesa, por urgencia</div>
